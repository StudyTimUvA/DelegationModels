...
class DelegationModelTests:
    ...
    def test_single_delegation(self):
        ...
        assert (
            self.service.has_access("party1", "owner1", "object2", "write") == True,
            "party1 should have access to object1 in DO->p1",
        )
        assert (
    ...
    def test_invalid_delegation(self):
        ...
        assert (
            not delegation,
            "Delegation should not be valid as party1 has no access to object3",
        )
    ...
    def test_simple_revocation(self):
        ...
        self.service.revoke_delegation(self.db, identifier)
